...
Stunnel_Port2='1443' # through OpenSSH
...
MyStunnelD
 ...
 openssl req -new -x509 -days 9999 -nodes -subj "/C=ID/ST=IDR/L=Jateng/O=$MyScriptName/OU=$MyScriptName/CN=$MyScriptName" -out /etc/stunnel/stunnel.pem -keyout /etc/stunnel/stunnel.pem &> /dev/null
##  > /dev/null 2>&1
